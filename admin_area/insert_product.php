...
<body class='bg-form'>
    <div class="container mt-3">
        <button class='btn btn-info mb-1 px-5' style='position:fixed '><a href="index.php" style="color: white; text-decoration: none;">Go back</a></button>
        <h1 class="text-center">Insert Product</h1>
        <!-- Form -->
        
        <form action="" method="post" enctype="multipart/form-data" class="border border-primary border-2 w-50 mx-auto  rounded-3 ">
            ...
            <div class="form-outline mb-1 w-75 mx-auto">
                <input type="submit" name="insert_product" class="btn btn-info mb-1 px-3" value="Insert Products">
            </div>
            </div>
        </form>
