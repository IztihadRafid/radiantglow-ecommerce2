...
if (isset($_POST['edit_product'])) {
    ...
    if (
        ...
        $product_category == '' or $product_brands == '' or $product_image1 == '' or $product_image2 == '' or $product_image3 == '' or $product_price == ''
    ) {
        echo "<script> alert('Please fill all the fields and continue the process')</script>";
    } else {
        move_uploaded_file($temp_image1, "./product_iamges/$product_image1");
        move_uploaded_file($temp_image2, "./product_iamges/$product_image2");
        move_uploaded_file($temp_image3, "./product_iamges/$product_image3");
