...
<table class="table table-bordered mt-5">
    <thead class="bg-dark text-white ">
        ...
        <td><a href='index.php?delete_all_payments=<?php echo $payment_id?>' type="button" class="text-light" data-toggle="modal" data-target="#exampleModal"><i class='fa-solid fa-trash'></i></a></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">  
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary"><a href='index.php?delete_all_payments=<?php echo $payment_id?>' class="text-light text-decoration-none" >Yes</a></button>
      </div>
    </div>
  </div>
</div>